...
local utils = require('neovim_purple.utils')
local neovim_purple = {}
...
local function set_groups()
  local groups = {
    ...
    PmenuSel = { fg = colors.fg, bg = colors.menu_selected },
    ...
    TSTag= { fg = colors.entity },
    TSTagDelimiter  = { fg = colors.entity },
...
function neovim_purple.colorscheme()
  ...
  vim.g.colors_name = 'neovim_purple'
